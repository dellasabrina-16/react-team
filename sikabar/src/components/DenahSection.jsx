...
import img from '../assets/images/feat-map.svg'
  ...
  return (
    <section className="flex flex-col md:flex-row items-center bg-gray-50 px-8 md:px-20 py-16 gap-10">
      <div className="flex-1 flex justify-center">
        <img src={img} alt="Denah" className="max-w-sm w-full object-contain" />
      </div>
      <div className="flex-1 flex flex-col gap-4">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Denah</h2>
        <p className="text-gray-600 text-base leading-relaxed">
          Informasi denah ruang pembelajaran, bengkel, laboratorium dan ruang di SMK PGRI Wlingi.
        </p>
